...
void main()
{
    ...
    const vec3 normal = get_normal(voxel);
    const bool shadowed = get_shadow(voxel) && get_shadowed(normal,
    ...
    o_color = get_color(color, shadowed, ssao, fog, normal, u_shadow_vector);
}